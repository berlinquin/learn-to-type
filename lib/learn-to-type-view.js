...
export default class LearnToTypeView {
  ...
  constructor(serializedState) {
    ...
    var unitsTop = document.createElement('div');
    unitsTop.id = 'units-top';
    unitsTop.textContent = 'words';
    var unitsBottom = document.createElement('div');
    unitsBottom.id = 'units-bottom';
    unitsBottom.textContent = 'minute';
    unitsDisplay.appendChild(unitsTop);
    unitsDisplay.appendChild(unitsBottom);
